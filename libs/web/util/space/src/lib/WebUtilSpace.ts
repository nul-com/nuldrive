...
import SpaceTravelContext, {
  SpaceTravelContextParameters,
} from './space-travel-context';
import SpaceTravelScene, {
  SpaceTravelSceneParameters,
} from './space-travel-scene';

interface SpaceTravelParameters
  extends SpaceTravelContextParameters,
    SpaceTravelSceneParameters {
  canvas: HTMLCanvasElement;
}

export default class WebUtilSpace {
