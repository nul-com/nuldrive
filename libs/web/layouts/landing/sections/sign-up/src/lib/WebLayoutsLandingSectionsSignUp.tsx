        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h1 className="h1">Welcome. We storify storage.</h1>
            </div>
            ...
            <div className="max-w-sm mx-auto">
              ...
              <div className="flex items-center my-6">
                <div
                  className="border-t border-gray-600 border-dotted grow mr-3"
                  aria-hidden="true"
                ></div>
                ...
                <div
                  className="border-t border-gray-600 border-dotted grow ml-3"
                  aria-hidden="true"
                ></div>
              </div>
              <form>
