...
export interface WebLayoutsLandingSectionsPostProps {}

export function WebLayoutsLandingSectionsPost(
  props: WebLayoutsLandingSectionsPostProps
) {
  return (
            ...
            <article>
              ...
              <div className="text-lg text-slate-300">
                <p className="mb-8">
                  ...
                  etiam sit amet.{' '}
                  <Link href="#">
                    <p className="text-gray-200 underline hover:no-underline cursor-pointer">
                      Ligula ullamcorper
                    </p>
                  </Link>{' '}
                  ...
                  <header>
                    ...
                    <div className="mb-3">
                      <ul className="flex flex-wrap text-xs font-medium -m-1">
                        <li className="m-1">
                          <Link href="#">
                            <p className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-purple-600 hover:bg-purple-700 transition duration-150 ease-in-out cursor-pointer">
                              Product
                            </p>
                          </Link>
                        </li>
                        <li className="m-1">
                          <Link href="#">
                            <p className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-green-500 hover:bg-green-600 transition duration-150 ease-in-out cursor-pointer">
                              Culture
                            </p>
                          </Link>
                        </li>
                    ...
                    <h3 className="h4 mb-2">
                      <Link href="/blog-post">
                        <p className="hover:text-gray-100 transition duration-150 ease-in-out cursor-pointer">
                  ...
                  <header>
                    ...
                    <div className="mb-3">
                      <ul className="flex flex-wrap text-xs font-medium -m-1">
                        <li className="m-1">
                          <Link href="#">
                            <p className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-pink-500 hover:bg-pink-600 transition duration-150 ease-in-out cursor-pointer">
                              Design
                            </p>
                          </Link>
                        </li>
                        <li className="m-1">
                          <Link href="#">
                            <p className="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-teal-500 hover:bg-teal-600 transition duration-150 ease-in-out cursor-pointer">
...
export default WebLayoutsLandingSectionsPost;
