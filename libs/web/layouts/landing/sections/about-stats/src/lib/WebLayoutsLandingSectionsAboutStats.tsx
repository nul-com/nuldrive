...
export interface WebLayoutsLandingSectionsAboutStatsProps {}

export function WebLayoutsLandingSectionsAboutStats(
  props: WebLayoutsLandingSectionsAboutStatsProps
) {
  return (
    <section>
          ...
          <div className="flex flex-col items-center pt-16 pb-12 md:pt-20 md:pb-16">
            <div className="relative">
              ...
              <img
                ...
                src="https://r2.eriascdn.com/planet-avatar-03.png"
                width="287"
                height="86"
              ...
              <img
                ...
                src="https://r2.eriascdn.com/planet-avatar-04.png"
                width="256"
                height="126"
...
export default WebLayoutsLandingSectionsAboutStats;
