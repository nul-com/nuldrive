            ...
            <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 md:gap-6 lg:gap-6 items-start md:max-w-none">
              ...
              <article className="flex flex-col h-full" data-aos="fade-up">
                <a className="block" href="#0">
                  <figure className="relative h-0 pb-9/16 overflow-hidden">
                    <WebUtilImageLoader
                      className="absolute inset-0 w-full h-full rounded-t-lg gobject-cover transform hover:scale-105 transition duration-700 ease-out"
                    ...
                    />
                    <Link href="/">
                      <figcaption className="absolute top-0 right-0 mt-4 mr-4 text-xs font-medium inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-slate-900 bg-opacity-75 pointer-events-none">
                        Case study
                      </figcaption>
                    </Link>
                  </figure>
                </a>
                <div className="grow flex flex-col h-full p-6 bg-slate-750 rounded-b-lg">
              ...
              >
                <a className="block" href="#0">
                  <figure className="relative h-0 pb-9/16 overflow-hidden">
                    <WebUtilImageLoader
                      className="absolute inset-0 w-full h-full rounded-t-lg object-cover transform hover:scale-105 transition duration-700 ease-out"
                ...
                <div className="grow flex flex-col h-full p-6 rounded-b-lg bg-slate-750">
                  <h3 className="h4 mb-2">
                    <a
                      className="hover:text-gray-100 transition duration-150 ease-in-out"
                      href="#0"
              ...
              >
                <a className="block" href="#0">
                  <figure className="relative h-0 pb-9/16 overflow-hidden">
                    <WebUtilImageLoader
                      className="absolute inset-0 w-full h-full object-cover rounded-t-lg transform hover:scale-105 transition duration-700 ease-out"
