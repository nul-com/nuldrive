...
import styles from './WebLayoutsLandingSectionsPricingCarousel.module.css';

/* eslint-disable-next-line */
export interface WebLayoutsLandingSectionsPricingCarouselProps {}

export function WebLayoutsLandingSectionsPricingCarousel(
  props: WebLayoutsLandingSectionsPricingCarouselProps
) {
  ...
  const [items] = useState<any>([
    {
      img: 'https://r2.eriascdn.com/testimonial-01.jpg',
      alt: 'Testimonial 01',
      quote:
    ...
    {
      img: 'https://r2.eriascdn.com/testimonial-02.jpg',
      alt: 'Testimonial 02',
      quote:
    ...
    {
      img: 'https://r2.eriascdn.com/testimonial-03.jpg',
      alt: 'Testimonial 03',
      quote:
              ...
              >
                {items.map((item: any, index: any) => (
                  ...
                  >
                    ...
                    <blockquote className="text-xl font-medium mb-4 text-gray-300">
                      {item.quote}
                    </blockquote>
                    <cite className="block font-bold text-lg not-italic mb-1 text-gray-400">
                      {item.name}
                    </cite>
                    <div className="text-gray-400">
                      <span>{item.role}</span>{' '}
                      <span className="text-blue-600 hover:underline">
                        <Link href={item.link}>{item.team}</Link>
                      </span>
                    </div>
                  </WebUtilTransition>
                ))}
...
export default WebLayoutsLandingSectionsPricingCarousel;
