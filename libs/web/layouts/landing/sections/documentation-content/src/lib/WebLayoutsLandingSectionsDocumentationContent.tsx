...
import styles from './WebLayoutsLandingSectionsDocumentationContent.module.css';

/* eslint-disable-next-line */
export interface WebLayoutsLandingSectionsDocumentationContentProps {}

export function WebLayoutsLandingSectionsDocumentationContent(
  props: WebLayoutsLandingSectionsDocumentationContentProps
) {
  return (
    <div className="md:grow">
      <div className="text-lg text-gray-300">
        <h2 className="h2 text-gray-100 mb-4">Introduction to Simple</h2>
        <p className="mb-8">
        ...
        <h3
          id="installation"
          className="h3 text-gray-100 mb-4"
        ...
        <figure className="mb-8">
          <WebUtilImageLoader
            ...
            src="https://r2.eriascdn.com/docs-image-01.png"
            width="768"
            height="390"
            alt="Docs 01"
          />
        ...
        <p className="flex items-center text-base px-3 py-4 bg-slate-700 border border-blue-200 rounded mb-8 cursor-pointer">
          ...
          <span className="text-blue-500 hover:underline">
            Check out the <Link href="#0">Terms and license page</Link> to know
            more about our license.
          </span>
        </p>
        <h3
          id="quick"
          className="h3 text-gray-100 mb-8"
          style={{ scrollMarginTop: '100px' }}
        >
          Quick start
        </h3>
        <h4 className="h4 text-gray-200 mb-4">Customising settings</h4>
        <p className="mb-8">
          ...
          <span className="text-gray-200 underline">
            <Link href="#0">netus et malesuada fames</Link>{' '}
          </span>
        ...
        <figure className="mb-8">
          <WebUtilImageLoader
            className="w-full rounded"
            src="https://r2.eriascdn.com/docs-image-02.png"
            width="768"
            height="390"
            alt="Docs 02"
          />
        ...
        <p className="flex items-center text-base px-3 py-4 text-gray-300 bg-slate-700 border border-blue-200 rounded mb-8">
          ...
          <span>
            ...
            <span className="text-blue-600 hover:underline">
              <Link href="#0">Customising settings</Link>
            </span>
            .
          </span>
        </p>
        ...
        <p className="mb-8">
          ...
          molestie ac feugiat sed lectus vestibulum mattis senectus et{' '}
          <Link href="#0">
            <span className="text-gray-200 underline cursor-pointer">
...
export default WebLayoutsLandingSectionsDocumentationContent;
